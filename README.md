[![serioussamc](https://snapcraft.io//serioussam/badge.svg)](https://snapcraft.io/serioussam)
<!--
...
-->
<h1 align="center">
  <img src="https://raw.githubusercontent.com/tx00100xt/SeriousSamClassic/main/SamTFE/serioussam.png" alt="SeriousSamClassic-VK">
  <br />
  SeriousSamClassic
</h1>

<p align="center"><b>This is a snap for SeriousSamClassic</b>
...
[![Get it from the Snap Store](https://snapcraft.io/static/images/badges/en/snap-store-white.svg)](https://snapcraft.io/serioussam)

   
  SeriouSamClassic is a family of enhanced ports of the Serious-Engine for running on modern operating systems.
  It runs on Windows, Linux, FreeBSD, OpenBSD, NetBSD, macOS and adds new features not found in the games as originally
...
This snap is now in the store, simply run
    ...
    $ sudo snap install serioussam --beta
...
in the git repo (serioussam-snap). Then install the produced snap with
...
## Running SeriousSamClassic with XPLUS modification
Run it from shell:
    ...
    tar -xJvpf SamTFE-XPLUS.tar.xz -C ~/snap/serioussam/current/.local/share/Serious-Engine/serioussam
    tar -xJvpf SamTSE-XPLUS.tar.xz -C ~/snap/serioussam/current/.local/share/Serious-Engine/serioussamse
...
## Screenshots
<h1 align="center">
  <img src="samxplus_1.png" alt="Screenshot 1 here!">
  <br/>
</h1>
<p align="center">SeriousSamClassic running on Linux with XPLUS Mod. Oasis</p>

<h1 align="center">
  <img src="samxplus_2.png" alt="Screenshot 2 here!">
  <br/>
</h1>
<p align="center">SeriousSamClassic running on Linux with XPLUS Mod. Dunes</p>

<h1 align="center">
  <img src="samxplus_3.png" alt="Screenshot 3 here!">
  <br/>
</h1>
<p align="center">SeriousSamClassic running on Linux with XPLUS Mod. Sacred Yards</p>
...
See https://raw.githubusercontent.com/tx00100xt/SeriousSamClassic/main/LICENSE
...
## Remaining tasks
  ...
  - [x] Post a call for testing on the [Snapcraft Forum](https://forum.snapcraft.io) - [link to the post](https://forum.snapcraft.io/t/call-for-testing-for-serioussamclassic/38870)
